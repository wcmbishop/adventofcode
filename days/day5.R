...
intcode <- Intcode$new(state = ints, inputs = 1)
intcode$run()
intcode$output
...
expect_equal(Intcode$new(int_ex, inputs = 1)$run()$output, 999)
expect_equal(Intcode$new(int_ex, inputs = 8)$run()$output, 1000)
expect_equal(Intcode$new(int_ex, inputs = 9)$run()$output, 1001)

intcode <- Intcode$new(state = ints, inputs = 5)
intcode$run()
intcode$output
